...
import {actions} from "./GuestReservations.slice";
...
export default function GuestReservations() {
    ...
    const {reservations} = useSelector((state: RootState) => state.guestReservations.result);
    const {reservationsStatus} = useSelector((state: RootState) => state.guestReservations.status);

    useEffect(() => {
        dispatch(actions.getGuestReservations())
    }, [dispatch]);
